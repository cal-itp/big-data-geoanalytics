"""
This utils file originally comes from [replica_utils.py](https://github.com/cal-itp/big-data-geoanalytics/blob/main/replica/LinkUS_locations_selections/replica_utils.py) within the LinkUS folder.
"""
